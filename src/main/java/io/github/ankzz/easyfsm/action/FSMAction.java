 ...
 **/
package io.github.ankzz.easyfsm.action;
 ...
 * @author ANKIT
 */
public abstract class FSMAction<EventData extends Object> {
     ...
     * @return
     */
    public abstract boolean action(String curState, String message, EventData data, String nextState, Object args);
     ...
     * happens.
     */
    public void afterTransition(String curState, String message, EventData data, String nextState, Object args) {
        /*
     ...
     * happens.
     */
    public void entry(String curState, String message, EventData data, String nextState, Object args) {
        /*
         * Can be used by the calling function after transition has taken place
         */
    }
     ...
     * happens.
     */
    public void exit(String curState, String message, EventData data, String nextState, Object args) {
        /*
         * Can be used by the calling function after transition has taken place
         */
    }
