...
public class FSMStates implements java.io.Serializable {
     ...
     * @throws IOException
     */
    public FSMStates(String configFName, boolean extFile) throws ParserConfigurationException, SAXException, IOException {

        if (!"".equals(configFName))
            this._configFileName = configFName;
        this._fsmStates = new ArrayList<FSMState>();
        CustomXMLReader _r = null;
        if (!extFile) {
            _r = new CustomXMLReader(this.getClass().getClassLoader().getResourceAsStream(this._configFileName));
        } else {
     ...
     * @throws IOException
     */
    public FSMStates(InputStream configFStream) throws ParserConfigurationException, SAXException, IOException {
     ...
     *            is received on specified state
     */
    public void setStateBeforeTransition(ArrayList<String> states, FSMStateAction act) {
        if (states == null) {
            states = _states;
        }
     ...
     *            is received on specified state
     */
    public void setStateAfterTransition(ArrayList<String> states, FSMStateAction act) {
        if (states == null) {
            states = _states;
        }
